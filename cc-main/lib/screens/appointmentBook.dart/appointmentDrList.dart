...
import '../memberLogin/doctorDetail.dart';
import '../widgets/memberPageBars.dart';
import 'appointmentDrDetail.dart';



class DoctorListAppointment extends StatelessWidget {
  List<dynamic> doctors;
  String? hsptlName;
  DoctorListAppointment({super.key,required this.doctors,required this.hsptlName});
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: (){
                ...
                MaterialPageRoute(builder: (context) => DoctorDetailAppointment(
                  ...
                  wing: doctors[index]['Wing'].toString(), day3: doctors[index]['Day3'] , time3:doctors[index]['Timing3'], hsptlName: hsptlName, days: doctors[index]['days'], 
                  )));                
              },
              child: DoctorListView(
                designation: doctors[index]['Speciality'], 
                hospital: doctors[index]['department'], 
                name: doctors[index]['ConsultantNames'], hsptlname: hsptlName,
                ),
            ),
          );
        }),
