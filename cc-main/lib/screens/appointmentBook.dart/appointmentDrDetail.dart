...
import '../memberLogin/hsptldependents.dart';
import '../subscreens/abc.dart';
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                flex: 2,
                                child:  Multi3S(color: Color(0xff164584), subtitle: "Days ", weight: FontWeight.bold, size: 12),),
                              Expanded(
                                flex: 2,
                                child:  Multi3S(color: Color(0xff164584), subtitle: "$days", weight: FontWeight.bold, size: 12),),
                            ],
                                      ...
                                      onPressed: () {
                                        Navigator.push(context,
                                          MaterialPageRoute(builder:
                                            (context) => 
                                            CalendarBooking(enabledWeekdays: days!.split(",").toList(), deptname: speciality, drName: name, hsptlname:hsptlName,)
                                            )
                                          );
                                      },
                                    )
