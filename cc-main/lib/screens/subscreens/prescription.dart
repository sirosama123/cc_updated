   ...
   FirebaseFirestore.instance
    ...
    try {
        ...
        Provider11.PrescriptionUrl = downloadURL;
          ...
          db.collection("medicines").doc("${Provider11.uniqueID}").set(
          {
      ...
      get().then((QuerySnapshot querySnapshot) {
       ...
       await sendmail("Medicine",patientname.text,age.text,Provider11.email.toString(),"${Provider11.number}","${Provider11.PrescriptionUrl}");
        setState(() {
