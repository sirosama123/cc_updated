...
class Approval2 extends StatelessWidget {
  String? relation;
  String? name;
  String? cnic;
  String? hc;
...
header.cells[0].value = '$hsptl_name';
...
page.graphics.drawString(
    ':   $hc', PdfStandardFont(PdfFontFamily.helvetica, 9.sp, style: PdfFontStyle.bold),
                          ...
                          Row(
                           ...
                           Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: cnic.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Multi3(color: Colors.white, subtitle: "Health Code", weight: FontWeight.bold, size: 16),
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: hc.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Multi3(color: Colors.white, subtitle: "Document No.", weight: FontWeight.bold, size: 16),
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: dn.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Multi3(color: Colors.white, subtitle: "Issue Date", weight: FontWeight.bold, size: 16),
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: idate.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Multi3(color: Colors.white, subtitle: "Plancode", weight: FontWeight.bold, size: 16),
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: pc.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Multi3(color: Colors.white, subtitle: "DOB", weight: FontWeight.bold, size: 16),
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: dob.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Multi3(color: Colors.white, subtitle: "Age", weight: FontWeight.bold, size: 16),
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: age.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              ...
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: gen.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
                           Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Multi3(color: Colors.white, subtitle: "Effective Date", weight: FontWeight.bold, size: 16),
                              SizedBox(width: 5.w,),
                              Multi3(color: Colors.white, subtitle: ed.toString(), weight: FontWeight.bold, size: 16),
                            ],
                          ),
