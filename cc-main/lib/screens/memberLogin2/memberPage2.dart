...
import 'package:project1/screens/memberLogin2/profile2.dart';
...
import '../widgets/memberPageBars.dart';
import 'hospitals2.dart';


class MemberPage2 extends StatelessWidget {
  const MemberPage2({super.key});
            ...
            children: [
              ...
              GestureDetector(
                onTap: ()async{
                   await Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => MemberHospitals2(
                                       hospitalcities: Provider11.hsptl_data,
                                        )));
                },
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () async{
                      print(Provider11.data2);
                      print(Provider11.data2.length);
                      await Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => MemberProfile2(
                                      data2: Provider11.data2,
                                        )));
                    },
