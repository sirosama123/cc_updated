...
import '../adminpanel/doctorAppointments.dart';

class Dashboard extends StatefulWidget {
  late int count;
   Dashboard({super.key,required this.count});
                                            ...
                                            GestureDetector(
                                              ...
                                              onTap: (){
                                                ...
                                                Provider11.med();
                                                 ...
                                                 Navigator.push(
                                                    context,
                                                    MaterialPageRoute(builder: (context) => MedicineOrderDetail()
                                                    ),
                                              );
                                              },
                                              ),
                                            GestureDetector(
                                              ...
                                              onTap: (){
                                                  ...
                                                  Provider11.lab();
                                                   ...
                                                   Navigator.push(
                                                    context,
                                                    MaterialPageRoute(builder: (context) => LabOrderDetail()
                                                    ),
                                              );
                                              },
                                              ),
                                      ...
                                      children: [
                                        GestureDetector(
                                          ...
                                          onTap: (){
                                            ...
                                            Provider11.medDetail();
                                            Provider11.med();
                                            if (Provider11.med_detail.length==0) {
                                        ...
                                        GestureDetector(
                                          ...
                                          onTap: (){
                                              ...
                                              if (Provider11.lab_detail.length==0) {
                                                 Fluttertoast.showToast(
